...
public class Consumer1 {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<ArtistName> artistList = c1.getArtists();
        ...
        ArrayList<MusicFile> album1 = c1.getAlbum("dogsounds"); //If you want change this to another artist
        ...
        ArrayList<MusicFile> chunkList1 = c1.getSongAndSaveItChunkByChunk(song1.artistName, song1,
                "C:\\Users\\paula\\Desktop\\c1chunks"); //TODO: Change the path to your consumer 1 folder

        //Restore the mp3 file and save the song.
        c1.saveSong(chunkList1 ,"C:\\Users\\paula\\Desktop\\c1chunks"); //TODO: Change the path to your consumer 1 folder
